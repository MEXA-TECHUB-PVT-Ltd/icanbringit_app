  ...
  return (
    <SafeAreaView style={{flex: 1, paddingTop: 50}}>
      <ScrollView style={{backgroundColor: '#ffff'}}>
        ...
        <FastImage source={Images.EventBG} style={{height: 200}} resizeMode="stretch">
          <TouchableOpacity
            style={{
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <CustomText text={'I’m excited to join'} style={{color: COLORS.white, fontSize: 13}} />
          </TouchableOpacity>
          <TouchableOpacity style={[styles.btnView, {width: 100, alignItems: 'center'}]}>
            <CustomText text={'I can’t Join'} style={{color: COLORS.white, fontSize: 13}} />
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity
            ...
            <CustomText text={'Maybe, I’ll Join'} style={{color: COLORS.white, fontSize: 13}} />
          </TouchableOpacity>
        </View>
